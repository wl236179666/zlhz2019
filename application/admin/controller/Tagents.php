...
class Tagents extends Base
{
	/**
	 * 省代列表
	 * @return [type] [description]
	 */
	public function indexTagents()
	{
		  if(request()->isAjax()){
	...
	public function addTagents()
	{
		if(request()->isPost()){
            ...
            $param['role_id'] = 4;
            $user = new UserModel();
            $flag = $user->insertUser($param,"tagents/indextagents");
	...
	public function updateTagents()
	{
        ...
        if(request()->isPost()){
            ...
            $flag = $user->editUser($param,"tagents/indextagents");
    ...
    private function makeButton($id)
    {
        return [
            '编辑' => [
                'auth' => 'tagents/updatetagents',
                'href' => url('tagents/updateTagents', ['id' => $id]),
                'btnStyle' => 'primary',
                'icon' => 'fa fa-paste'
            ],
            '删除' => [
                'auth' => 'tagents/deltagents',
