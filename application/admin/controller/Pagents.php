...
class Pagents extends Base
{
	/**
	 * 省代列表
	 * @return [type] [description]
	 */
	public function indexPagents()
	{
		  if(request()->isAjax()){
	...
	public function addPagents()
	{
		if(request()->isPost()){
            ...
            $param['role_id'] = 2;
            $user = new UserModel();
            $flag = $user->insertUser($param,"pagents/indexpagents");
	...
	public function updatePagents()
	{
        ...
        if(request()->isPost()){
            ...
            $flag = $user->editUser($param,"pagents/indexpagents");
    ...
    private function makeButton($id)
    {
        return [
            '编辑' => [
                'auth' => 'pagents/updatepagents',
                'href' => url('pagents/updatePagents', ['id' => $id]),
                'btnStyle' => 'primary',
                'icon' => 'fa fa-paste'
            ],
            '删除' => [
                'auth' => 'pagents/delpagents',
